 ...
 */
public class DefaultBlake3 implements Blake3 {
    ...
    private static void roundFn(int[] state, int[] m) {
        mixColumns(state, m);
        mixDiagnonals(state, m);
    }

    private static void mixDiagnonals(int[] state, int[] m) {
    ...
    private static void mixColumns(int[] state, int[] m) {
    ...
    public DefaultBlake3() {
        initialize(IV, 0);
    }

    public DefaultBlake3(byte[] key) {
    ...
    public DefaultBlake3(String context) {
        DefaultBlake3 contextHasher = new DefaultBlake3();
