...
public class VectorizedBlake3Factory implements Blake3Factory {
    /**
     * Construct a BLAKE3 blake3 hasher
     */
    public Blake3 newInstance() {
        return new VectorizedBlake3();
    }
    ...
    public Blake3 newKeyedHasher(byte[] key) {
        return new VectorizedBlake3(key);
    }
    ...
    public Blake3 newKeyDerivationHasher(String context) {
        return new VectorizedBlake3(context);
    }
}
